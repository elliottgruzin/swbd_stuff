...
# get the TRPs generated by the model
...
def extract_eval(file_name):
    'for each dialogue file find whether classification correct or not using k-kappa as an evaluation metric'
    ...
    # get gold standard dialogue acts via the transcription data
...
# refer to k-kappa formula to understand these terms    
